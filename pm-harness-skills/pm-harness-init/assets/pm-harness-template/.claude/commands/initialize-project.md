...
description: 根据 project.yaml 完成项目基础设施（DS / API / Test / Docker / Sprint-0000）
category: Bootstrap
...
/initialize-project
    ...
    ├─ Docker / .env.example
    └─ /sprint-propose sprint-0000   （登记已交付治理迭代）
```
...
□ iterations/sprint-0000 四件套存在
□ openspec/specs 含 design-system、api-governance、testing
```

## Next

业务需求走 **`/req-capture`** … **`/sprint-propose sprint-0001`**，勿再调用本命令。
