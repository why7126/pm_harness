...
| Web/小程序/移动端交互变化 | 对应 OpenSpec spec、原型、`rules/ui-design.md`、兼容性文档 |
...
需求治理的详细规则由 `rules/requirement-management.md` 定义；Bug 治理的详细规则由 `rules/bug-management.md` 定义。本文只规定目录归属与同步边界。
...
| 小程序/移动端/桌面端 | 对应端 spec、兼容性文档、测试计划 |
...
7. 根据 `{PRODUCT_FORMS}` 生成 Web、小程序、移动端、桌面端相关文档同步规则。
