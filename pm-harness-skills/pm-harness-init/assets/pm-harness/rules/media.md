...
- `[条件启用]`：仅在对应能力启用时保留，例如图片、音频、视频、录音、转码、对象存储、小程序播放。
...
| 视频 | MP4、MOV、WebM | 待确认 | 小程序/移动端需控制体积 |
...
4. 根据 `{PRODUCT_FORMS}` 生成 Web、小程序、移动端、桌面端的上传、预览、播放限制。
