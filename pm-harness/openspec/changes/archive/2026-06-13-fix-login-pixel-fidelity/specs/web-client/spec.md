...
登录页视觉对齐 MUST 通过 PNG golden reference 验收 gate，方可标记 REQ-0001 / Sprint 01 视觉项完成。
...
- **AND** 结果 MUST 记录在 `openspec/changes/fix-login-pixel-fidelity/trace.md` 与 `iterations/sprint-01/acceptance-report.md`
