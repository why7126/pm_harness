...
scope: 后端、前端、移动端、微信小程序、算法、脚本、共享代码、测试辅助代码
...
> - **[条件启用]**：只有项目具备对应能力时才保留或展开，例如后端、前端、微信小程序、算法、对象存储、异步任务。
...
| `{MOBILE_STACK}` | 移动端/微信小程序技术栈 | [条件启用] |
...
4. 根据后端框架生成实际分层和模块结构。
5. 根据前端、移动端、微信小程序、算法、对象存储、异步任务能力生成对应规则。
